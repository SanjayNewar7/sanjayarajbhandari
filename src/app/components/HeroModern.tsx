...
export function HeroModern() {
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden bg-slate-50 pt-4 sm:pt-8 md:pt-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12 items-center">
          ...
          >
            ...
            >
              <a
                href="#portfolio"
                className="group px-8 py-4 bg-blue-600 text-white rounded-xl hover:bg-blue-700 hover:shadow-2xl hover:shadow-blue-600/30 transition-all duration-300 flex items-center gap-2"
              >
            ...
            >
              {[
                ...
                { name: 'Instagram', url: 'https://www.instagram.com/the_archer.np/', icon: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/instagram.svg' },
