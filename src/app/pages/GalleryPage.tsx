            ...
            {workflowSteps.map((step, index) => (
              ...
              >
                ...
                {index !== workflowSteps.length - 1 && (
                  <div className="absolute left-10 top-20 w-0.5 h-full bg-gradient-to-b from-blue-600 to-cyan-600 opacity-30"></div>
                )}

                {/* Number Badge */}
                <div className="flex-shrink-0 relative z-10">
                  <div className="w-20 h-20 bg-gradient-to-br from-blue-600 via-blue-500 to-cyan-600 rounded-3xl flex items-center justify-center shadow-xl group-hover:shadow-2xl group-hover:scale-110 transition-all duration-500">
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-cyan-600 text-white">
        <div className="container mx-auto px-6 sm:px-8 lg:px-12 xl:px-16 text-center">
          ...
          >
            ...
            <a
              href="https://wa.me/9779817262424"
              target="_blank"
