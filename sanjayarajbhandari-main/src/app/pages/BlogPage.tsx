...
export function BlogPage() {
  ...
  return (
    <div className="min-h-screen bg-blue-50">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 bg-[#0a84ff] text-white">
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-12 xl:px-16 text-center">
          ...
          >
            ...
            <div className="max-w-md mx-auto flex gap-3">
              ...
              />
              <button className="px-8 py-4 bg-white text-blue-600 rounded-lg font-bold hover:shadow-lg transition-all">
                Subscribe
              </button>
            </div>
          </motion.div>
