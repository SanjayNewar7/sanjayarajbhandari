...
export function CategoryPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-14 md:pb-16 bg-[#0a84ff] text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <Link
            ...
            onClick={(e) => {
              e.preventDefault();
              // Navigate to home first, then scroll to work
      ...
      <section className="py-12 sm:py-16 md:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {data.works.map((work, index) => (
              ...
              >
                ...
                {/* Overlay */}
                <div className="absolute inset-x-0 bottom-0 glass-scrim opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4 sm:p-5 md:p-6">
          ...
          >
            <div className="bg-[#0a84ff] rounded-2xl sm:rounded-3xl p-8 sm:p-10 md:p-12 shadow-xl sm:shadow-2xl">
