        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Graphic Designer, Web Developer, Mobile App Developer & UI/UX Designer. Co-Founder of{' '}
              <a href="https://www.loopixcreations.com.np/" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 transition-colors">
                Loopix Creations
              </a>, building brands, apps, and products end to end.
            </p>
            <div className="flex gap-4">
              ...
              <a
                href="https://www.figma.com/@sanjaya"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gray-800 p-2 rounded-full hover:bg-gray-700 transition-colors"
              >
                <img src="https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/figma.svg" alt="Figma" className="w-5 h-5 invert" />
              </a>
              <a
